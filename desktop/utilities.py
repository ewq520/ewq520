...
def send_activation_notification(user):
    ...
    subject = render_to_string('desktop/email/activation_letter_subject.txt', context)
    body_text = render_to_string('desktop/email/activation_letter_body.txt', context)
